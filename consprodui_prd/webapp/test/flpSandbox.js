		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcconsproduiconsproduiprd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcconsproduiconsproduiprd-display": {
								"semanticObject": "commgcconsproduiconsproduiprd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.consprodui.consproduiprd",
									"url": sap.ui.require.toUrl("com/mgc/consprodui/consproduiprd")
								}
							}
						}
					}
